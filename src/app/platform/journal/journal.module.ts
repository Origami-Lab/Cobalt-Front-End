...
@NgModule({
  declarations: [JournalPageComponent, JournalListComponent, JournalCalendarFilterComponent],
  imports: [CommonModule, SharedModule, JournalRoutingModule, NgxDatatableModule, NgxSmoothScrollModule]
})
